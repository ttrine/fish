...
from fish.layers import LogisticLossDecay, SpecialBatchNormalization
...
if __name__ == '__main__':
	...
	initial_loss = 2.
	cov_decay = LogisticLossDecay(initial_loss, -1., .5, 15, 2.)

	model = ClassifierContainer(name,construct(),32,"adam", loss_weights=[initial_loss,1.], callbacks=[cov_decay])
