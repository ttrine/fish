...
from keras.layers import Input, Dense, Flatten, merge, Reshape, ZeroPadding2D, Convolution2D, MaxPooling2D, Dropout
...
def construct():
	...
	conv2 = Convolution2D(64, 5, 5, activation='relu', name="stem_2")(conv2)
	...
	# Detector. Approximates image's coverage matrix.
	conv_coverage = ZeroPadding2D((1, 1))(conv_gate)
	conv_coverage = Convolution2D(1, 3, 3, activation='sigmoid', name="detect_1")(conv_coverage)
